...
func TestEventsRoutes(t *testing.T) {
	...
	t.Run("GET_sensor_history", func(t *testing.T) {
		t.Run("valid_request_200", func(t *testing.T) {
			w := httptest.NewRecorder()

			req, _ := http.NewRequest(http.MethodGet, "/sensors/1/history?start_date=2021-01-01T00:00:00Z&end_date=2021-01-02T00:00:00Z", bytes.NewReader([]byte{}))
			req.Header.Add("Accept", "application/json")
			router.ServeHTTP(w, req)
		...
		t.Run("sensor_doesnt_exist_404", func(t *testing.T) {
			...
			req, _ := http.NewRequest(http.MethodGet, "/sensors/2/history?start_date=2021-01-01T00:00:00Z&end_date=2021-01-02T00:00:00Z", nil)
			req.Header.Add("Accept", "application/json")
			router.ServeHTTP(w, req)
		...
		t.Run("no_time_422", func(t *testing.T) {
			w := httptest.NewRecorder()

			req, _ := http.NewRequest(http.MethodGet, "/sensors/2/history?end_date=2021-01-02T00:00:00Z", nil)
			req.Header.Add("Accept", "application/json")
			router.ServeHTTP(w, req)
		...
		t.Run("no_time_2_422", func(t *testing.T) {
			w := httptest.NewRecorder()

			req, _ := http.NewRequest(http.MethodGet, "/sensors/2/history?start_date=2021-01-01T00:00:00Z", nil)
			req.Header.Add("Accept", "application/json")
			router.ServeHTTP(w, req)
