...
func (s *DefaultAPIService) BannerIdPatch(ctx context.Context, id int32, bannerIdPatchRequest BannerIdPatchRequest, token string) (ImplResponse, error) {
...
func (s *DefaultAPIService) BannerPost(ctx context.Context, bannerPostRequest BannerPostRequest, token string) (ImplResponse, error) {
