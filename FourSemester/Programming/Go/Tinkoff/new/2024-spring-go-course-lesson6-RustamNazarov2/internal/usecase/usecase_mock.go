...
func (m *MockEventRepository) GetSensorHistory(ctx context.Context, id int64, st, fn time.Time) ([]domain.Event, error) {
	m.ctrl.T.Helper()
...
func (mr *MockEventRepositoryMockRecorder) GetSensorHistory(ctx, id, st, fn interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSensorHistory", reflect.TypeOf((*MockEventRepository)(nil).GetSensorHistory), ctx, id, st, fn)
}
