...
func (c *DefaultAPIController) BannerIdPatch(w http.ResponseWriter, r *http.Request) {
	...
	bannerIdPatchRequestParam := BannerIdPatchRequest{}
	...
	if err := AssertBannerIdPatchRequestRequired(bannerIdPatchRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertBannerIdPatchRequestConstraints(bannerIdPatchRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	tokenParam := r.Header.Get("token")
	result, err := c.service.BannerIdPatch(r.Context(), idParam, bannerIdPatchRequestParam, tokenParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *DefaultAPIController) BannerPost(w http.ResponseWriter, r *http.Request) {
	bannerPostRequestParam := BannerPostRequest{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	...
	if err := AssertBannerPostRequestRequired(bannerPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertBannerPostRequestConstraints(bannerPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	tokenParam := r.Header.Get("token")
	result, err := c.service.BannerPost(r.Context(), bannerPostRequestParam, tokenParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
